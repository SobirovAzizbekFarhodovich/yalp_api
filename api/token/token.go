...
func GenereteJWTToken(user *pb.LoginUserResponse) *Tokens {
  ...
  claims["first_name"] = user.Password
  claims["last_name"] = user.FullName
  claims["password_hash"] = user.Role
  ...
  rftclaims["first_name"] = user.Password
  rftclaims["last_name"] = user.FullName
  rftclaims["password_hash"] = user.Role
